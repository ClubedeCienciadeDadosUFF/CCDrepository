...
jQuery(function($){
       ...
       $(window).scroll(function(){
        if($(window).scrollTop() >100 /*or $(window).height()*/){
            $(".navbar-fixed-top").addClass('past-main');
						$("#test").attr("src", "img/logo.png");
        }
    else{
      $(".navbar-fixed-top").removeClass('past-main');
			$("#test").attr("src", "img/logo1.png");
      }
    });
		...
		$(document).ready(function(){
				$(window).scroll(function(){
						...
						if (offset <= 0) {
		            $("#animation-mvlogo").attr("src", "img/logo.png");
		        } else {
							$("#animation-mvlogo").attr("src", "img/logo1.png");
						}
		        });
		    });
	...
	/* ----------------------------------------------------------- */
      ...
      $('#map_canvas').gmap().bind('init', function(ev, map) {
        $('#map_canvas').gmap('addMarker', {'position': '-22.904887, -43.131208', 'bounds': true});
